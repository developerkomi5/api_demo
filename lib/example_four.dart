//this is the solution when you're not able to build a model
//because plugin is not responding or any other reason
...
class _ExampleFourState extends State<ExampleFour> {
  //dynamic variable for storing the api data
  var data;
